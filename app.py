...
# Set your API key
os.environ["GOOGLE_API_KEY"] = "AIzaSyDkyhnXgUBKLS_tQLRsM2rXvFgCXULxtOg"
...
@app.route('/')
def index():
    return render_template('diet-predictor.html', recommendations=None)
...
def recommendations():
    if request.method == "POST":
        ...
        return render_template('diet-predictor.html', recommendations=recommendations)
